        ...
        <form onSubmit={(e) => {e.preventDefault(); handleSubmit()}}>
          <div className="flex justify-between p-2 pb-6">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-slate-800 text-lg font-bold">Add New Product</h2>
            </div>
            <button type = "submit"className="bg-green-400 text-slate-800 px-4 py-2 rounded-full hover:bg-green-500 flex items-center gap-2 transition-all">
              <IoMdCheckmark />
              <p>Add Product</p>
            </button>
          </div>
          <div className="bg-white shadow-slate-200 shadow-sm rounded-2xl p-4 mx-4">
            ...
            <div className="pt-6">
              <label className="block mb-2 text-slate-800">Name Product (3-100 characters)</label>
              <input
                type="text"
            ...
            <div className="pt-6">
              <label className="block mb-2 text-slate-800">Product Description (10-1000 characters)</label>
              <input
                type="text"
            ...
            <div className="pt-6">
              <label className="block mb-2 text-slate-800 font-medium">Product Images</label>
                ...
                {selectedFiles.length > 0 ? (
                  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                    {selectedFiles.map((file, index) => (
                      <div key={index} className="w-full aspect-square bg-white border rounded-lg overflow-hidden shadow-sm flex items-center justify-center">
                        <Image
