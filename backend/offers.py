...
async def user_create_offer(session_token: str, csrf_token:str, offered_item_ids: Optional[list[str]], requested_item_id:str, message:str) :
    ...
    new_offered_item_ids = [int(item_id) for item_id in offered_item_ids if item_id.isdigit()]
